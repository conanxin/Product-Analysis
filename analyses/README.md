...
### AI Structured Knowledge Workspace / Agentic Meeting
- **Tana** — tana.inc (agentic meeting platform: native video calls + Meeting Agent + AI agents + Skills + MCP/API + GitHub/Slack/HubSpot/Linear/Jira/Pipedrive/Claude/Cursor/Codex/Copilot/Lovable) + outliner.tana.inc (Tana Outliner: Supertags / Nodes / Knowledge graph / Tana AI / Meeting notetaker / Voice memos / Tana Publish / AI image generation / Templates / MCP)；私人公司（Norway / Nordic）/ $14M Series A 2025-02-03 / $25M total funding（Tola Capital lead + Lightspeed Northzone Alliance VC Firstminute follow-on）/ 160K stealth waitlist / 24K+ Tanarians；SOC2 Q3 2026 / GDPR / HIPAA Q3 2026
